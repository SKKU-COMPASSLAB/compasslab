...
params:
    ...
    email:     "sam2227@skku.edu"         # school email address
    
    profile_image: sangkyu_park.jpg  # put the filename of the profile image here 
    ...
    biography: |   # fill out your short biography... Introduce yourself!
        I am an undergraduate researcher in the Department of Semiconductor Systems Engineering at Sungkyunkwan University (SKKU). I am focused on research in memory systems and storage technologies.
