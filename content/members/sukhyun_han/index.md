...
params:
    ...
    linkedin:   https://www.linkedin.com/in/sukhyun-han1010/
    
    profile_image: sukhyun_han.jpeg  # TODO: put the filename of the profile image here
    ...
    experiences:  # provide your professional experiences
        ...
        - {
            ...
            exp_desc: "Master's degree at Sungkyunkwan University (SKKU)"
        }
        - {
            exp_from: "2019",
            exp_to:   "2024",
            exp_desc: "Bachelor's degree at Sungkyunkwan University (SKKU)"
        }
