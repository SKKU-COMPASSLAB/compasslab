...
date:   2024-06-23  # publication date (not the blog posting date...)
...
params:
    ...
    pub_venue: "2024 Design Automation Conference (DAC 2024) (Poster)"  # full venue name (conference and journal name)
